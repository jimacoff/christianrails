...
RSpec.describe Store::PriceCombo, type: :model do
  ...
  it "should have and belong to many products" do
    p = Store::PriceCombo.create(name: "Cat-related bundle", discount: 4.99)
  ...
  it "should have many orders" do
    p = Store::PriceCombo.create(name: "Jar-related bundle", discount: 3.99)
    o1 = Store::Order.create(price_combo: p, payment_id: "rakka", payer_id: "snaka", total: 4.65)
    o2 = Store::Order.create(price_combo: p, payment_id: "arara", payer_id: "maarara", total: 1.75)
  ...
  describe 'satisfied_for?' do
    ...
    it 'should identify a satisfied combo' do
      combo = Store::PriceCombo.create(name: "Reasonably-priced bundle", discount: 2.50)
  ...
  describe 'combos_satisfied_for' do
    ...
    it 'should return an array of the price combos satisfied' do
      combo = Store::PriceCombo.create(name: "Some bundle", discount: 6.50)
      combo.products << product_1
      combo.products << product_2
  ...
  describe 'total_cart_discount_for' do
    ...
    it 'should return a discount for one satisfied price combo' do
      combo = Store::PriceCombo.create(name: "Pretty good deal", discount: 2.50)
      combo.products << product_1
      combo.products << product_2
      ...
      expect( Store::PriceCombo.total_cart_discount_for(user.id) ).to eq(2.50)

    end

    it 'should return a discount for more than one satisfied price combo' do
      combo1 = Store::PriceCombo.create(name: "Pretty good deal", discount: 2.50)
      combo2 = Store::PriceCombo.create(name: "Amazing deal", discount: 5.25)
      # set up combo 1
      ...
      expect( Store::PriceCombo.total_cart_discount_for(user.id) ).to eq(7.75)
    end
