  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new PriceCombo" do
        expect {
          post :create, params: {:price_combo => valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved price_combo as @price_combo" do
        post :create, params: {:price_combo => invalid_attributes}, session: valid_session
        expect(assigns(:price_combo)).to be_a_new(PriceCombo)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested price_combo" do
        price_combo = PriceCombo.create! valid_attributes
        put :update, params: {:id => price_combo.to_param, :price_combo => new_attributes}, session: valid_session
        price_combo.reload
      ...
      it "assigns the requested price_combo as @price_combo" do
        price_combo = PriceCombo.create! valid_attributes
        put :update, params: {:id => price_combo.to_param, :price_combo => valid_attributes}, session: valid_session
        expect(assigns(:price_combo)).to eq(price_combo)
      end
    ...
    context "with invalid params" do
      it "assigns the price_combo as @price_combo" do
        price_combo = PriceCombo.create! valid_attributes
        put :update, params: {:id => price_combo.to_param, :price_combo => invalid_attributes}, session: valid_session
        expect(assigns(:price_combo)).to eq(price_combo)
      end
    end
  end
