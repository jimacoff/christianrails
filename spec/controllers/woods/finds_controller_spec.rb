...
RSpec.describe Woods::FindsController, type: :controller do

  # This should return the minimal set of attributes required to create a valid
  # Woods::Find. As you add validations to Woods::Find, be sure to
  ...
  # Woods::FindsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Woods::Find" do
        expect {
      ...
      it "redirects to the created woods_find" do
        post :create, {:woods_find => valid_attributes}, valid_session
        expect(response).to redirect_to(Woods::Find.last)
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested woods_find" do
        find = Woods::Find.create! valid_attributes
        put :update, {:id => find.to_param, :woods_find => new_attributes}, valid_session
        find.reload
  ...
  describe "DELETE #destroy" do
    it "destroys the requested woods_find" do
      find = Woods::Find.create! valid_attributes
      expect {
    ...
    it "redirects to the woods_finds list" do
      find = Woods::Find.create! valid_attributes
      delete :destroy, {:id => find.to_param}, valid_session
      expect(response).to redirect_to(woods_finds_url)
    end
  end
