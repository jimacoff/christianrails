...
RSpec.describe Woods::PlayersController, type: :controller do

  # This should return the minimal set of attributes required to create a valid
  # Woods::Player. As you add validations to Woods::Player, be sure to
  ...
  # Woods::PlayersController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Woods::Player" do
        expect {
      ...
      it "redirects to the created woods_player" do
        post :create, {:woods_player => valid_attributes}, valid_session
        expect(response).to redirect_to(Woods::Player.last)
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested woods_player" do
        player = Woods::Player.create! valid_attributes
        put :update, {:id => player.to_param, :woods_player => new_attributes}, valid_session
        player.reload
  ...
  describe "DELETE #destroy" do
    it "destroys the requested woods_player" do
      player = Woods::Player.create! valid_attributes
      expect {
    ...
    it "redirects to the woods_players list" do
      player = Woods::Player.create! valid_attributes
      delete :destroy, {:id => player.to_param}, valid_session
      expect(response).to redirect_to(woods_players_url)
    end
  end
