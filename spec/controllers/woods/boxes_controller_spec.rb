...
RSpec.describe Woods::BoxesController, type: :controller do

  # This should return the minimal set of attributes required to create a valid
  # Woods::Box. As you add validations to Woods::Box, be sure to
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created woods_box" do
        post :create, {:woods_box => valid_attributes}, valid_session
        expect(response).to redirect_to(Woods::Box.last)
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested woods_box" do
        box = Woods::Box.create! valid_attributes
        put :update, {:id => box.to_param, :woods_box => new_attributes}, valid_session
        box.reload
