...
RSpec.describe Woods::PossibleitemsController, type: :controller do

  # This should return the minimal set of attributes required to create a valid
  # Woods::Possibleitem. As you add validations to Woods::Possibleitem, be sure to
  ...
  # Woods::PossibleitemsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Woods::Possibleitem" do
        expect {
      ...
      it "redirects to the created woods_possibleitem" do
        post :create, {:woods_possibleitem => valid_attributes}, valid_session
        expect(response).to redirect_to(Woods::Possibleitem.last)
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested woods_possibleitem" do
        possibleitem = Woods::Possibleitem.create! valid_attributes
        put :update, {:id => possibleitem.to_param, :woods_possibleitem => new_attributes}, valid_session
        possibleitem.reload
      ...
      it "redirects to the woods_possibleitem" do
        possibleitem = Woods::Possibleitem.create! valid_attributes
        put :update, {:id => possibleitem.to_param, :woods_possibleitem => valid_attributes}, valid_session
        expect(response).to redirect_to(possibleitem)
      end
    end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested woods_possibleitem" do
      possibleitem = Woods::Possibleitem.create! valid_attributes
      expect {
        delete :destroy, {:id => possibleitem.to_param}, valid_session
      }.to change(Woods::Possibleitem, :count).by(-1)
    end

    it "redirects to the woods_possibleitems list" do
      possibleitem = Woods::Possibleitem.create! valid_attributes
      delete :destroy, {:id => possibleitem.to_param}, valid_session
      expect(response).to redirect_to(woods_possibleitems_url)
    end
  end
