...
RSpec.describe Woods::FootprintsController, type: :controller do

  # This should return the minimal set of attributes required to create a valid
  # Woods::Footprint. As you add validations to Woods::Footprint, be sure to
  ...
  # Woods::FootprintsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Woods::Footprint" do
        expect {
      ...
      it "redirects to the created woods_footprint" do
        post :create, {:woods_footprint => valid_attributes}, valid_session
        expect(response).to redirect_to(Woods::Footprint.last)
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested woods_footprint" do
        footprint = Woods::Footprint.create! valid_attributes
        put :update, {:id => footprint.to_param, :woods_footprint => new_attributes}, valid_session
        footprint.reload
  ...
  describe "DELETE #destroy" do
    it "destroys the requested woods_footprint" do
      footprint = Woods::Footprint.create! valid_attributes
      expect {
        delete :destroy, {:id => footprint.to_param}, valid_session
      }.to change(Woods::Footprint, :count).by(-1)
    end

    it "redirects to the woods_footprints list" do
      footprint = Woods::Footprint.create! valid_attributes
      delete :destroy, {:id => footprint.to_param}, valid_session
      expect(response).to redirect_to(woods_footprints_url)
    end
  end
