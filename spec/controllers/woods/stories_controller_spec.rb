...
RSpec.describe Woods::StoriesController, type: :controller do
  ...
  # Woods::Story. As you add validations to Woods::Story, be sure to
  ...
  # Woods::StoriesController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Woods::Story" do
        expect {
      ...
      it "redirects to the created woods_story" do
        post :create, {:woods_story => valid_attributes}, valid_session
        expect(response).to redirect_to(Woods::Story.last)
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested woods_story" do
        story = Woods::Story.create! valid_attributes
        put :update, {:id => story.to_param, :woods_story => new_attributes}, valid_session
        story.reload
  ...
  describe "DELETE #destroy" do
    it "destroys the requested woods_story" do
      story = Woods::Story.create! valid_attributes
      expect {
    ...
    it "redirects to the woods_stories list" do
      story = Woods::Story.create! valid_attributes
      delete :destroy, {:id => story.to_param}, valid_session
      expect(response).to redirect_to(woods_stories_url)
    end
  end
