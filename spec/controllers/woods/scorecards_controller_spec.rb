...
RSpec.describe Woods::ScorecardsController, type: :controller do

  # This should return the minimal set of attributes required to create a valid
  # Woods::Scorecard. As you add validations to Woods::Scorecard, be sure to
  ...
  # Woods::ScorecardsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Woods::Scorecard" do
        expect {
      ...
      it "redirects to the created woods_scorecard" do
        post :create, {:woods_scorecard => valid_attributes}, valid_session
        expect(response).to redirect_to(Woods::Scorecard.last)
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested woods_scorecard" do
        scorecard = Woods::Scorecard.create! valid_attributes
        put :update, {:id => scorecard.to_param, :woods_scorecard => new_attributes}, valid_session
        scorecard.reload
  ...
  describe "DELETE #destroy" do
    it "destroys the requested woods_scorecard" do
      scorecard = Woods::Scorecard.create! valid_attributes
      expect {
        delete :destroy, {:id => scorecard.to_param}, valid_session
      }.to change(Woods::Scorecard, :count).by(-1)
    end

    it "redirects to the woods_scorecards list" do
      scorecard = Woods::Scorecard.create! valid_attributes
      delete :destroy, {:id => scorecard.to_param}, valid_session
      expect(response).to redirect_to(woods_scorecards_url)
    end
  end
