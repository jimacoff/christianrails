...
RSpec.describe Woods::MoverulesController, type: :controller do

  # This should return the minimal set of attributes required to create a valid
  # Woods::Moverule. As you add validations to Woods::Moverule, be sure to
  ...
  # Woods::MoverulesController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Woods::Moverule" do
        expect {
      ...
      it "redirects to the created woods_moverule" do
        post :create, {:woods_moverule => valid_attributes}, valid_session
        expect(response).to redirect_to(Woods::Moverule.last)
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested woods_moverule" do
        moverule = Woods::Moverule.create! valid_attributes
        put :update, {:id => moverule.to_param, :woods_moverule => new_attributes}, valid_session
        moverule.reload
      ...
      it "redirects to the woods_moverule" do
        moverule = Woods::Moverule.create! valid_attributes
        put :update, {:id => moverule.to_param, :woods_moverule => valid_attributes}, valid_session
        expect(response).to redirect_to(moverule)
      end
    end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested woods_moverule" do
      moverule = Woods::Moverule.create! valid_attributes
      expect {
        delete :destroy, {:id => moverule.to_param}, valid_session
      }.to change(Woods::Moverule, :count).by(-1)
    end

    it "redirects to the woods_moverules list" do
      moverule = Woods::Moverule.create! valid_attributes
      delete :destroy, {:id => moverule.to_param}, valid_session
      expect(response).to redirect_to(woods_moverules_url)
    end
  end
