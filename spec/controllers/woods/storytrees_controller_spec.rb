...
RSpec.describe Woods::StorytreesController, type: :controller do

  # This should return the minimal set of attributes required to create a valid
  # Woods::Storytree. As you add validations to Woods::Storytree, be sure to
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Woods::Storytree" do
        expect {
      ...
      it "redirects to the created woods_storytree" do
        post :create, {:woods_storytree => valid_attributes}, valid_session
        expect(response).to redirect_to(Woods::Storytree.last)
      end
    end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested woods_storytree" do
      storytree = Woods::Storytree.create! valid_attributes
      expect {
        delete :destroy, {:id => storytree.to_param}, valid_session
      }.to change(Woods::Storytree, :count).by(-1)
    end

    it "redirects to the woods_storytrees list" do
      storytree = Woods::Storytree.create! valid_attributes
      delete :destroy, {:id => storytree.to_param}, valid_session
      expect(response).to redirect_to(woods_storytrees_url)
    end
  end
