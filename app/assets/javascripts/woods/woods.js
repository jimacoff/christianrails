...
function scrollToAnchor() {
 $("html, body").animate( { scrollTop: $('#woods-anchor').offset().top + "px" } );
}
...
function showItem() {
  ...
  $('#imagepanel').html( "<img src='/assets/" + storyname + "/d_" + item_gallery[item_index]['image'] + ".jpg' class='df-image'>" );
